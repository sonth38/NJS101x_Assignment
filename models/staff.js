...
staffSchema.methods.updateLeave = function (leaveInfo) {
  ...
  if (
    hourLeave <= countdownHourAnnualLeave &&
    hourLeave <= singleDateLeave.length * 8
  ) {
...
staffSchema.methods.updateInjection = function (vaccineInfo) {
  const firstVaccineInfo = {
    nameVaccine: vaccineInfo.nameFirstVaccine,
    date: vaccineInfo.dateFirstVaccine,
  };
  const secondVaccineInfo = {
    nameVaccine: vaccineInfo.nameSecondVaccine,
    date: vaccineInfo.dateSecondVaccine,
  };
